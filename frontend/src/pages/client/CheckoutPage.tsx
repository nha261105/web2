...
import { CartLayout, LeftCartLayout, RightCartLayout } from "@/layouts/client/CartLayout";
    ...
    return <CartLayout>
        ...
        <div className="w-full flex flex-row justify-between gap-10 flex-wrap">
            ...
            <RightCartLayout>
              ...
              {
                    products.map((item) => (
                        <div className="flex flex-row bg-white gap-1 items-center">
                            <img src={item.img} alt="meme" className="w-10 h-10 rounded-md cursor-pointer"/>
                            <div className="w-full flex flex-col justify-between">
                                <div className="w-full flex flex-row justify-between">
                                    <div className="flex flex-col gap-0.5">
                                        <div className="text-xs font-semibold hover:cursor-pointer hover:text-blue-700">{item.name}</div>
                                        <div className="text-xs font-medium text-gray-500">{item.price}</div>
                                    </div>
                                </div>
                            </div>
